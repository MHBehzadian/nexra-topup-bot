...
SUPERADMIN_WELCOME = (
    "سلام سوپرادمین 👋\n"
    "هر کاربر جدیدی بات رو استارت بزنه، یا درخواست شارژ/تغییر رمز ثبت کنه، اینجا برات پیام میاد "
    "و می‌تونی مستقیم زیر همون پیام تأیید/رد/پیام‌دادن رو بزنی.\n\n"
    "درخواست‌های شارژ در انتظار رو هم می‌تونی از دکمه‌ی زیر هر وقت خواستی مرور کنی."
)
BTN_PENDING_REQUESTS = "📋 درخواست‌های در انتظار"
NO_PENDING_REQUESTS = "درخواست شارژ در انتظاری وجود نداره."
